...
import { 
  View, Text, ImageBackground, KeyboardAvoidingView, Platform, TouchableOpacity, Pressable, ActivityIndicator
} from 'react-native';
...
// CHANGED: Fixed imports to point to the correct src location
      ...
      <View className="w-full items-center">
        ...
        <OTPInput 
          ...
          onComplete={(code) => { 
            ...
            if (code.length === 6) setTimeout(handleOtpSubmit, 500); 
          }} 
        />
